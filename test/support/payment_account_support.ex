defmodule PaymentServerWeb.Support.AccountsPayments do
  ...
  def create_user(_opts \\ []) do
    {:ok, user} = Accounts.create_user(%{email: "carlmaria1996@gmail.com", name: "Benjamin Xu"})
    %{user: user}
  end
  ...
  def create_wallets(_opts \\ []) do
    {:ok, user1} = Accounts.create_user(%{email: "carlmaria1996@gmail.com", name: "Benjamin Xu"})
